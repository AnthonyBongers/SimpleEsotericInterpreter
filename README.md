...
The esoteric language implemented in this repository is the BrainFuck [\(wikipedia\)](https://en.wikipedia.org/wiki/Brainfuck) language, which is a minimalistic language, and a great study of memory and pointers. Although the language consists of only 8 commands, BrainFuck is a Turing Complete language, allowing addition, subtraction, IO, and conditional branching. 
